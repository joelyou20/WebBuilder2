...
namespace WebBuilder2.Server.Migrations
{
    ...
    [Migration("20250105231534_UpdateSiteRepositoryIdToBeNullable")]
    partial class UpdateSiteRepositoryIdToBeNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebBuilder2.Server.Data.Models.Repository", b =>
                {
                    ...
                    b.Property<long?>("SiteRepositoryId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebBuilder2.Server.Data.Models.Site", b =>
                {
                    ...
                    b.Property<string>("SSLARN")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("SSLCertificateIssueDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("WebBuilder2.Server.Data.Models.SiteRepository", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SiteRepository");
                });

            modelBuilder.Entity("WebBuilder2.Shared.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebBuilder2.Shared.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebBuilder2.Server.Data.Models.SiteRepository", b =>
                {
                    b.HasOne("WebBuilder2.Server.Data.Models.Repository", "Repository")
                        .WithOne("SiteRepository")
                        .HasForeignKey("WebBuilder2.Server.Data.Models.SiteRepository", "RepositoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebBuilder2.Server.Data.Models.Site", "Site")
                        .WithOne("SiteRepository")
                        .HasForeignKey("WebBuilder2.Server.Data.Models.SiteRepository", "SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
